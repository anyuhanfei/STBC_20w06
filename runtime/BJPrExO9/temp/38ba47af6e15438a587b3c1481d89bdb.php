            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">C2C管理</div>
                    ...
                    <div class="card-body">
                        <form class="form-inline" role="form" action="" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="buy_phone" id="buy_phone" value="<?php echo htmlentities($buy_phone); ?>" placeholder="买家会员手机号" style="width: 150px;">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="sell_phone" id="sell_phone" value="<?php echo htmlentities($sell_phone); ?>" placeholder="卖家会员手机号" style="width: 150px;">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="deal_id" id="deal_id" value="<?php echo htmlentities($deal_id); ?>" placeholder="交易单号" style="width: 150px;">
                            </div>
                        ...
                        <table class="table mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" width="8%">买家手机号</th>
                                    <th scope="col" width="8%">卖家手机号</th>
                                    <th scope="col" width="10%">金额</th>
                                    <th scope="col" width="11%">单价</th>
                                    <th scope="col" width="5%">状态</th>
                                    <th scope="col" width="11%">挂卖时间</th>
                                    <th scope="col" width="11%">操作时间</th>
                                    <th scope="col" width="6%">支付类型</th>
                                    <th scope="col" width="6%">充值凭证</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo htmlentities($vo['deal_id']); ?></td>
                                    <td><?php echo htmlentities($vo['buyuser']['phone']); ?></td>
                                    <td><?php echo htmlentities($vo['selluser']['phone']); ?></td>
                                    <td><?php echo htmlentities($vo['amount']); ?></td>
                                    <td><?php echo htmlentities($vo['unit_price']); ?></td>
                                    <td><?php echo htmlentities($vo['status_text']); ?></td>
                                    <td><?php echo htmlentities($vo['insert_time']); ?></td>
                                    <td><?php echo htmlentities($vo['operation_time']); ?></td>
                                    <td><?php echo htmlentities($vo['pay_type']); ?></td>
                                    <td>
                                        <?php if($vo['pay_prove'] != ''): ?>
                                        <img id="image<?php echo htmlentities($vo['deal_id']); ?>" src="<?php echo htmlentities($vo['pay_prove']); ?>" width="60px" height="60px" onclick="show_image('<?php echo htmlentities($vo['deal_id']); ?>')"/>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                    </td>
