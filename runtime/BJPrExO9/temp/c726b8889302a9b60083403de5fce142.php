                        ...
                        <table class="table mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <?php if($cms_category_image_onoff == true): ?>
                            ...
                            <tbody>
                                ...
                                <tr id="tr<?php echo htmlentities($vo['category_id']); ?>">
                                    <td><?php echo htmlentities($vo['sort']); ?></td>
                                    <td><?php echo htmlentities($vo['category_id']); ?></td>
                                    <td><?php echo htmlentities($vo['category_name']); ?></td>
                                    <?php if($cms_category_image_onoff == true): ?>
                                    <td><img id="image<?php echo htmlentities($vo['category_id']); ?>" src="<?php echo htmlentities($vo['category_image']); ?>" width="60px" height="60px" onclick="show_image('<?php echo htmlentities($vo['category_id']); ?>')"/></td>
                                    <?php endif; ?>
                                    <td>
                                    </td>
                                </tr>
