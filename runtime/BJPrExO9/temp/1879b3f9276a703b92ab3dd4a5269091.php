                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table mt-3">
                            ...
                            <tbody>
                                <?php if(is_array($adv) || $adv instanceof \think\Collection || $adv instanceof \think\Paginator): $i = 0; $__LIST__ = $adv;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$advvo): $mod = ($i % 2 );++$i;?>
                                <tr id="tr<?php echo htmlentities($advvo['adv_id']); ?>">
                                    <td id="td<?php echo htmlentities($advvo['adv_id']); ?>" data-status="1" onclick="show('<?php echo htmlentities($advvo['adv_id']); ?>')">
                                        <i class="la la-caret-down"></i>
                                    </td>
                                    <td><b><?php echo htmlentities($advvo['adv_name']); ?></b></td>
                                    <?php if($developer_model== true): ?>
                                    <td></td>
                                    <td><b><?php echo htmlentities($advvo['sign']); ?></b></td>
                                    <?php endif; ?>
                                    <td></td>
                                    <td></td>
                                    <td>
                                    ...
                                    <?php if(is_array($ad) || $ad instanceof \think\Collection || $ad instanceof \think\Paginator): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$advo): $mod = ($i % 2 );++$i;if($advo['adv_id'] == $advvo['adv_id']): ?>
                                    <tr id="tr<?php echo htmlentities($advo['ad_id']); ?>" class="tr<?php echo htmlentities($advo['adv_id']); ?>">
                                        <td></td>
                                        <td></td>
                                        <?php if($developer_model== true): ?>
                                        <td><?php echo htmlentities($advo['ad_id']); ?></td>
                                        <td><?php echo htmlentities($advo['sign']); ?></td>
                                        <?php endif; ?>
                                        <td><?php echo htmlentities($advo['title']); ?></td>
                                        <td>
                                            <?php if($advo['image'] != ''): ?>
                                                <img id="image<?php echo htmlentities($advo['ad_id']); ?>" src="<?php echo htmlentities($advo['image']); ?>" width="60px" height="60px" onclick="show_image('<?php echo htmlentities($advo['ad_id']); ?>')"/>
                                            <?php endif; if($advo['value'] != ''): ?>
                                                <?php echo htmlentities($advo['value']); ?>
                                            <?php endif; if($advo['content'] != ''): ?>
                                            <button class="btn btn-warning btn-xs" onclick="show_content('<?php echo htmlentities($advo['ad_id']); ?>')">查看</button>
                                            <?php endif; ?>
                                        </td>
                                        <td style="display: none;" id="content<?php echo htmlentities($advo['ad_id']); ?>">
                                            <?php echo $advo['content']; ?>
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
