            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">管理员操作日志</div>
                        <div class="card-sub text-warning">
                            管理员在后台管理系统中的操作记录，可通过管理员的账号，管理员的昵称，操作时的ip，操作时间段进行检索查询。
                        </div>
                    </div>
                    <div class="card-body">
                        <form class="form-inline" role="form" action="" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="account" id="account" value="<?php echo htmlentities($account); ?>" placeholder="管理员账号">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="nickname" id="nickname" value="<?php echo htmlentities($nickname); ?>" placeholder="管理员昵称">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="ip" id="ip" value="<?php echo htmlentities($ip); ?>" placeholder="ip">
                            </div>
                            <div class="form-group">
                                <input id='mydatepicker1' type="text" class="form-control" name="start_time" placeholder="起始时间" value="">
                            </div>
                            <div class="form-group">
                                <input id='mydatepicker2' type="text" class="form-control" name="end_time" placeholder="结束时间" value="">
                            </div>
                        ...
                        <table class="table mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($vo['admin']['nickname']); ?>（<?php echo htmlentities($vo['admin']['account']); ?>）</td>
