                    ...
                    <div class="card-body">
                        <form class="form-inline" role="form" action="" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="user_identity" id="user_identity" value="<?php echo htmlentities($user_identity); ?>" placeholder="<?php echo htmlentities($user_identity_text); ?>">
                            </div>
                            <div class="form-group">
                                <select class="form-control form-control" name="coin_type" id="coin_type">
                                    <option value="">选择币种</option>
                                    <?php foreach($user_fund_type as $key=> $value): ?>
                                    <option value="<?php echo htmlentities($value); ?>" <?php if($coin_type == $value): ?>selected<?php endif; ?>><?php echo htmlentities($key); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <select class="form-control form-control" name="fund_type" id="fund_type">
                                    ...
                                    <?php if(is_array($fund_type_text) || $fund_type_text instanceof \think\Collection || $fund_type_text instanceof \think\Paginator): $i = 0; $__LIST__ = $fund_type_text;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ftt): $mod = ($i % 2 );++$i;?>
                                    <option value="<?php echo htmlentities($ftt); ?>" <?php if($fund_type == $ftt): ?>selected<?php endif; ?>><?php echo htmlentities($ftt); ?></option>
                        ...
                        <table class="table mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" width="15%"><?php echo htmlentities($user_identity_text); ?></th>
                                    <th scope="col">金额</th>
                                    <th scope="col">币种</th>
                                    <th scope="col">操作</th>
                                    <th scope="col">说明</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php if($vo['coin_type'] == 'STBC'): ?>STBC<?php else: ?><?php echo htmlentities($user_fund_type_flip[$vo['coin_type']]); ?><?php endif; ?></td>
                                    <td><?php echo htmlentities($vo['fund_type']); ?></td>
                                    <td><?php echo htmlentities($vo['content']); ?></td>
                                    <td><?php echo htmlentities($vo['remark']); ?></td>
                                    <td><?php echo htmlentities($vo['insert_time']); ?></td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
...
<script type="text/javascript">
    ...
    setTimeout(function(){
        var start_time = "<?php echo htmlentities($start_time); ?>";
        var end_time = "<?php echo htmlentities($end_time); ?>";
        if(start_time != ''){
