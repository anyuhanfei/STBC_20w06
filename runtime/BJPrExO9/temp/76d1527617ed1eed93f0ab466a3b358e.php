                    ...
                    <div class="card-body">
                        <form class="form-inline" role="form" action="" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="user_id" id="user_id" value="<?php echo htmlentities($user_id); ?>" placeholder="会员id" style="width: 150px;">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="nickname" id="nickname" value="<?php echo htmlentities($nickname); ?>" placeholder="会员昵称" style="width: 150px;">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="user_identity" id="user_identity" value="<?php echo htmlentities($search_user_identity); ?>" placeholder="会员<?php echo htmlentities($user_identity_text); ?>" style="width: 150px;">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="top_user_id" id="top_user_id" value="<?php echo htmlentities($top_user_id); ?>" placeholder="上级会员id" style="width: 150px;">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="top_user_identity" id="top_user_identity" value="<?php echo htmlentities($top_user_identity); ?>" placeholder="上级会员<?php echo htmlentities($user_identity_text); ?>" style="width: 150px;">
                            </div>
                        ...
                        <table class="table mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" width="10%"><?php echo htmlentities($user_identity_text); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr id="tr<?php echo htmlentities($vo->user_id); ?>">
                                    <td><?php echo htmlentities($vo['user_id']); ?></td>
                                    <td><?php echo htmlentities($vo['nickname']); ?></td>
                                    <td><?php echo htmlentities($vo->$user_identity); ?></td>
                                    <?php if($vo['top_id'] != 0): ?>
                                    <td><?php echo htmlentities($vo['top']->$user_identity); ?></td>
                                    <?php else: ?>
                                    <td></td>
                                    <?php endif; ?>
                                    <td>
                                        <?php foreach($user_fund_type as $k => $v): ?>
                                            <?php echo htmlentities($k); ?>: <?php echo htmlentities($vo['userfund']->$v); ?>&nbsp&nbsp&nbsp&nbsp
                                        <?php endforeach; ?>
                                    </td>
                                    <td id="login<?php echo htmlentities($vo['user_id']); ?>"><?php echo htmlentities($vo['is_login_text']); ?></td>
                                    <td><?php echo htmlentities($vo['register_time']); ?></td>
                                    <td>
                                        <button class="btn btn-success btn-xs" onclick="team('<?php echo htmlentities($vo['user_id']); ?>')">团队</button>
                                        <button class="btn btn-success btn-xs" onclick="detail('<?php echo htmlentities($vo['user_id']); ?>')">详情</button>
                                    </td>
                                </tr>
...
<script>
    ...
    //团队
    function team(id){
        location.href = "/BJPrExO9/user/team/" + id;
    }

    //详情
    function detail(id){
        location.href = "/BJPrExO9/user/detail/" + id;
    }
