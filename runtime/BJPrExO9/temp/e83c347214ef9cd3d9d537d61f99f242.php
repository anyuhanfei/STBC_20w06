                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-inline" role="form" action="" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="ip" id="ip" value="<?php echo htmlentities($ip); ?>" placeholder="IP地址">
                            </div>
                            <div class="form-group">
