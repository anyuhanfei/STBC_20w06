                    ...
                    <div class="card-body">
                        <form class="form-inline" role="form" action="" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="user_account" id="user_account" value="<?php echo htmlentities($user_account); ?>" placeholder="会员<?php echo htmlentities($user_identity_text); ?>" style="width: 150px;">
                            </div>
                        ...
                        <table class="table mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" width="8%"><?php echo htmlentities($user_identity_text); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($vo->user->phone); ?></td>
                                    <td><?php echo htmlentities($vo->amount); ?></td>
                                    <td><?php echo htmlentities($vo->user->userdata->stbc); ?></td>
                                    <td id="status<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['status_text']); ?></td>
                                    <td><?php echo htmlentities($vo['insert_time']); ?></td>
                                    <td><?php echo htmlentities($vo['operation_time']); ?></td>
                                    <td>
                                        <img id="image<?php echo htmlentities($vo['id']); ?>" src="<?php echo htmlentities($vo['prove']); ?>" width="60px" height="60px" onclick="show_image(<?php echo htmlentities($vo['id']); ?>)"/>
                                    </td>
                                    <td id="button<?php echo htmlentities($vo['id']); ?>">
                                    </td>
                                </tr>
