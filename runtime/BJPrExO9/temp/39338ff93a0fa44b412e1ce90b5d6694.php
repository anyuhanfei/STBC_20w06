                    ...
                    <div class="card-body">
                        <form class="form-inline" action="" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="title" id="title" value="<?php echo htmlentities($title); ?>" placeholder="搜索标题" style="width: 150px;">
                            </div>
                            <div class="form-group">
                                <select class="form-control form-control" name="category_id" id="category_id">
                                    ...
                                    <option value="<?php echo htmlentities($c['category_id']); ?>" <?php if($category_id == $c['category_id']): ?>selected<?php endif; ?>><?php echo htmlentities($c['category_name']); ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <?php if($cms_article['tag_ids'] == true): ?>
                            <div class="form-group">
                                <select class="form-control form-control" name="tag_id" id="tag_id">
                                    ...
                                    <option value="<?php echo htmlentities($t['tag_id']); ?>" <?php if($tag_id == $t['tag_id']): ?>selected<?php endif; ?>><?php echo htmlentities($t['tag_name']); ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <?php endif; if($cms_article['author'] == true): ?>
                            <div class="form-group">
                                <input type="text" class="form-control" name="author" id="author" value="<?php echo htmlentities($author); ?>" placeholder="搜索作者" style="width: 150px;">
                            </div>
                            <?php endif; ?>
                        ...
                        <table class="table mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <?php if($cms_article['stick'] == true): ?>
                                    <th scope="col" width="5%">置顶</th>
                                    <?php endif; if($cms_article['hot'] == true): ?>
                                    <th scope="col" width="5%">热门</th>
                                    <?php endif; if($cms_article['recomment'] == true): ?>
                                    <th scope="col" width="5%">推荐</th>
                                    <?php endif; if($cms_article['image'] == true): ?>
                            ...
                            <tbody>
                                ...
                                <tr id="tr<?php echo htmlentities($vo['article_id']); ?>">
                                    <td><?php echo htmlentities($vo['article_id']); ?></td>
                                    <?php if($cms_article['stick'] == true): ?>
                                    <td>
                                        <div onclick="status('stick', '<?php echo htmlentities($vo['article_id']); ?>')">
                                            <input type="checkbox" <?php if($vo['artdata']['is_stick'] == 1): ?>checked<?php endif; ?> data-toggle="toggle" data-onstyle="danger">
                                        </div>
                                    </td>
                                    <?php endif; if($cms_article['hot'] == true): ?>
                                    <td>
                                        <div onclick="status('hot', '<?php echo htmlentities($vo['article_id']); ?>')">
                                            <input type="checkbox" <?php if($vo['artdata']['is_hot'] == 1): ?>checked<?php endif; ?> data-toggle="toggle" data-onstyle="danger">
                                        </div>
                                    </td>
                                    <?php endif; if($cms_article['recomment'] == true): ?>
                                    <td>
                                        <div id="divrecomment<?php echo htmlentities($vo['article_id']); ?>" onclick="status('recomment', '<?php echo htmlentities($vo['article_id']); ?>')">
                                            <input id="recomment<?php echo htmlentities($vo['article_id']); ?>" type="checkbox" <?php if($vo['artdata']['is_recomment'] == 1): ?>checked<?php endif; ?> data-toggle="toggle" data-onstyle="danger">
                                        </div>
                                    </td>
                                    <?php endif; if($cms_article['image'] == true): ?>
                                    <td>
                                        <img id="image<?php echo htmlentities($vo['article_id']); ?>" src="<?php echo htmlentities($vo['image']); ?>" width="60px" height="60px" onclick="show_image('<?php echo htmlentities($vo['article_id']); ?>')"/>
                                    </td>
                                    <?php endif; ?>
                                    <td><?php echo htmlentities($vo['title']); ?></td>
                                    <td><?php echo htmlentities($vo['category']['category_name']); ?></td>
                                    <?php if($cms_article['tag_ids'] == true): ?>
                                    <td><?php echo htmlentities($vo['tag_ids']); ?></td>
                                    <?php endif; if($cms_article['author'] == true): ?>
                                    <td><?php echo htmlentities($vo['author']); ?></td>
                                    <?php endif; ?>
                                    <td><?php echo htmlentities($vo['artdata']['looknum']); ?></td>
                                    <td><?php echo htmlentities($vo['artdata']['likenum']); ?></td>
                                    <td>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
