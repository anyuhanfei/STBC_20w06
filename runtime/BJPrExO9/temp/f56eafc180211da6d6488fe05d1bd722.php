                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-sub text-warning">
                            <?php echo htmlentities($user->$user_identity); ?>的团队会员，直推人数：<?php echo htmlentities($user_count['down_team_number']); ?>，团队人数：<?php echo htmlentities($user_count['team_number']); ?>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table mt-3">
                            ...
                            <tbody>
                                ...
                                <tr class="tr<?php echo htmlentities($vo['top_id']); ?>" <?php if($vo->level != 1): ?>style="display: none;"<?php endif; ?>>
                                    <td id="td<?php echo htmlentities($vo['user_id']); ?>" data-status="0" onclick="show('<?php echo htmlentities($vo['user_id']); ?>')">
                                        <?php echo str_repeat('&nbsp', ($vo->level - 1) * 8); ?>
                                        <i class="la la-caret-right" id='i<?php echo htmlentities($vo['user_id']); ?>'></i>
                                        <?php echo str_repeat('&nbsp', 16); ?>
                                        <span><?php echo htmlentities($vo['user_id']); ?></span>
                                        <?php echo str_repeat('&nbsp', 20); ?>
                                        <span><?php echo htmlentities($vo['nickname']); ?></span>
                                        <?php echo str_repeat('&nbsp', 20); ?>
                                        <span><?php echo htmlentities($vo->$user_identity); ?></span>
                                    </td>
                                </tr>
