                    ...
                    <div class="card-body">
                        <form class="form-inline" role="form" action="" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="user_account" id="user_account" value="<?php echo htmlentities($user_account); ?>" placeholder="会员手机号" style="width: 150px;">
                            </div>
                        ...
                        <table class="table mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo htmlentities($vo['invest_id']); ?></td>
                                    <td><?php echo htmlentities($vo['user_id']); ?></td>
                                    <td><?php echo htmlentities($vo['user']['phone']); ?></td>
                                    <td><?php echo htmlentities($vo->amount); ?></td>
                                    <td><?php echo htmlentities($vo->period); ?></td>
                                    <td id="status<?php echo htmlentities($vo['invest_id']); ?>"><?php echo htmlentities($vo['has_static_text']); ?></td>
